...
/*
Plugin Name: Mybooking Importer
Plugin URI: https://wordpress.org/plugins/one-click-demo-import/
Description: Get Mybooking's demo content in just one click. Set up a renting site in minutes.
Version: 2.6.1
...
class OCDI_Plugin {
	...
	public function old_php_admin_error_notice() {
		$message = sprintf( esc_html__( 'The %2$sMybooking Demo Import%3$s plugin requires %2$sPHP 5.3.2+%3$s to run properly. Please contact your hosting company and ask them to update the PHP version of your site to at least PHP 5.3.2.%4$s Your current version of PHP: %2$s%1$s%3$s', 'pt-ocdi' ), phpversion(), '<strong>', '</strong>', '<br>' );
...
// Gets demo content
require_once( 'inc/DemoContentList.php' );
